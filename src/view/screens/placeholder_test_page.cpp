...
void PlaceholderTestPage::build_content(lv_obj_t* content) {
  ...
  lv_label_set_text(title_label, title_ ? title_ : "Placeholder Test");
  ...
  lv_label_set_text(body_label, message_ ? message_ : "This test page is not implemented yet.");
  lv_obj_set_width(body_label, 260);
  lv_obj_set_style_text_align(body_label, LV_TEXT_ALIGN_CENTER, 0);
  auto* body_font = assets_ref_().load_font("inter-medium.ttf", 14);
