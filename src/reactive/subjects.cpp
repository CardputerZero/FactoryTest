...
Subject::~Subject() { deinit_(); }

lv_subject_t* Subject::native() { return &subject_; }

const lv_subject_t* Subject::native() const { return &subject_; }

lv_subject_type_t Subject::type() const { return static_cast<lv_subject_type_t>(subject_.type); }

void Subject::notify() { lv_subject_notify(native()); }

void Subject::deinit_() {
  if (initialized_) {
...
void IntSubject::set(int32_t value) { lv_subject_set_int(native(), value); }

void IntSubject::set_min(int32_t value) { lv_subject_set_min_value_int(native(), value); }

void IntSubject::set_max(int32_t value) { lv_subject_set_max_value_int(native(), value); }
...
void BoolSubject::set(bool value) { lv_subject_set_int(native(), value ? 1 : 0); }

void BoolSubject::toggle() { set(!value()); }
...
void FloatSubject::set(float value) { lv_subject_set_float(native(), value); }

void FloatSubject::set_min(float value) { lv_subject_set_min_value_float(native(), value); }

void FloatSubject::set_max(float value) { lv_subject_set_max_value_float(native(), value); }
#endif
...
void ColorSubject::set(lv_color_t value) { lv_subject_set_color(native(), value); }
